...
const QUOTE_SECTIONS = [
  ...
  { id:'header',     type:'header',     name:'Header',             enabled:true,  order:1,
    settings:{ bgColor:'#0F172A', textColor:'#FFFFFF', logoUrl:'', logoPosition:'left', logoHeight:48,
               showCompanyName:true, companyName:'Business Pro', tagline:'Enterprise Solutions',
  ...
  { id:'footer',     type:'footer',     name:'Footer',             enabled:true,  order:10,
    settings:{ bgColor:'#0F172A', textColor:'#FFFFFF', leftText:'Business Pro ERP',
      ...
      case 'bank': return (
        <div key={sec.id} style={{background:s.bgColor||'#EFF6FF',padding:'10px 24px',borderTop:`1px solid ${s.borderColor||'#BFDBFE'}`,fontSize:11}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'3px 16px'}}>
            {[['Bank',s.bankName||'HDFC Bank Ltd'],['Account Name',s.accountName||'Business Pro Solutions'],['Account No.',s.accountNumber||'XXXX XXXX 1234'],['IFSC',s.ifscCode||'HDFC0001234'],['Branch',s.branchName||'Andheri East'],s.upiId&&['UPI',s.upiId]].filter(Boolean).map(([l,v])=>(
